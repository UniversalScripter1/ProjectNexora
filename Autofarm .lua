...
-- STYLE: macOS Light Theme | FIX: Typography & Sidebar Scale | VERSION: 3.9.5
...
SideMenu.Size = UDim2.new(0, 160, 0, 200) -- Increased width and height
...
local function CreateSideBtn(text, order, callback)
    ...
    btn.Size = UDim2.new(1, -16, 0, 36) -- Larger buttons
    btn.BackgroundColor3 = Color3.fromRGB(245, 245, 245)
    btn.Text = text
    btn.Font = Config.BoldFont -- Better font
    btn.TextSize = 11 -- Slightly bigger
...
CreateSideBtn("Auto Execute", 1, function()
    if writefile then writefile(Config.FileName, "loadstring(game:HttpGet('https://raw.githubusercontent.com/UniversalScripter1/ProjectNexora/refs/heads/main/Autofarm%20.lua'))()") end
