    ...
    function()
        ...
        local Window =
            WindUI:CreateWindow(
            {
                Title = "Script Eliana ",
                Icon = "laptop",
                Author = "discord.gg/project-reverse",
                Folder = "ChunkHubmm2",
        ...
        DiscordTab:Paragraph(
            {
                ...
                Desc = "Join our Discord to Get Best Scripts!",
                Image = "users",
                Color = "Blue"
            }
        )
...
DiscordTab:Button(
    {
        ...
        Callback = function()
            task.spawn(
                function()
                    setclipboard("https://discord.gg/project-reverse")
                    WindUI:Notify(
                        {
                            ...
                            Color = "Green"  -- Optional: makes it look positive
                        }
                    )
                end
            )
        ...
        PetsTab:Button(
            {
                ...
                Callback = function()
                        ...
                        function()
                            ...
                            if not petId then
                                ...
                                WindUI:Notify(
                                    {
                                        Title = "Error",
                                        Content = "Pet Not Found. Join our Discord for Help! discord.gg/SnXQCYzGjx",
                                        Icon = "shield-alert",
                                        Duration = 2
                                    }
                                )
                    ...
                    WindUI:Notify(
                        {
                            Title = "Spawning Item",
                            Content = "Spawned " .. petName .. " " .. petType,
                            Icon = "loader",
                            Duration = 2
                        }
                    )
